...
half4 fragAllWork(Varyings IN, bool shouldOnlyDoAlphaClipAndEarlyExit = false, bool isExtraCustomPass = false,bool haveAlphaClip = true)
{
...
half4 fragUniversalForwardNoAlphaClip(Varyings IN) : SV_Target
{
    return fragAllWork(IN, false, false ,false);
}
