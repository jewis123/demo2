...
namespace SuperCLine.ActionEngine
{
    ...
    public abstract class Unit : XObject, IUObjectDetacher
    {
        ...
        {
            mUController = mUObject.GetComponentInChildren<CharacterController>();
            ...
            mUCollider = mUObject.GetComponentInChildren<CapsuleCollider>();
            if (mUCollider != null)
            {
            ...
            {
                mUCollider = mUObject.GetComponentInChildren<Collider>();
            }
        ...
        public virtual Weapon CreateWeapon(string id)
        {
            ...
            //         break;
            //     case WeaponProperty.EWeaponType.EWT_GUN:
            //         weapon = new Gun(this, wp);
            //         break;
            //     default:
            ...
            Weapon weapon = new Weapon(this, wp);
            return weapon;
        }
