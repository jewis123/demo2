...
namespace SuperCLine.ActionEngine
{
    ...
    public sealed class ActionInterrupt : IEventData, IProperty
    {
        ...
        public void CopyFrom(ActionInterrupt r)
        {
            this.Enabled = r.Enabled;
            this.CheckAllCondition = r.CheckAllCondition;
            this.ConditionList.Clear();
            using (var itr = r.ConditionList.GetEnumerator())
            {
                while (itr.MoveNext())
                {
                    this.ConditionList.Add(itr.Current.Clone());
                }
            }
        }
