...
namespace SuperCLine.ActionEngine
{
    ...
    public sealed class WeaponProperty : IProperty
    {
        ...
        [SerializeField] private string mAttachDummyIdle;   //收束位置
        [SerializeField] private string mAttachDummyAttackL;  //左持位置
        [SerializeField] private string mAttachDummyAttackR;  //右持位置
