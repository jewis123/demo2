...
namespace SuperCLine.ActionEngine
{
    ...
    public sealed class HitAction : IProperty, IHitFeedback
    {
        ...
        {
            if (attackee.IsDead ||
                (attackee.ActionStatus.ActiveAction != null && !attackee.ActionStatus.ActiveAction.CanHit))
            {
                return;
            }
            ...
            var obj = attackee.PropertyContext.GetProperty(PropertyName.sHitAction);
            Helper.SetAny<string>(obj, hitAction);
            attackee.OnHit?.Invoke(attacker.UObject.gameObject);
        }
