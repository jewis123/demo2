...
namespace SuperCLine.ActionEngine
{
    ...
    public sealed class PhysicalEntity : AttackEntity
    {
        ...
        private PhysicalEntityProperty p;
        ...
        public override void BuildEntity()
        {
            ...
            p = Property as PhysicalEntityProperty;
        ...
        {
            bool isHit;
            UUnit unit = collision.gameObject.GetComponent<UUnit>();
            switch (p.HitType)
            {
                case HitFilterType.HitAll:
                    isHit = true;
                    break;
                case HitFilterType.HitEnermy:
                    isHit =  unit != null && unit.Owner != null && AH.Owner.TeamIdx != unit.Owner.TeamIdx;
                    break;
                case HitFilterType.HitSelf:
                    isHit = collision.transform == AH.Owner.UObject.transform;
                    break;
                case HitFilterType.HitTeamate:
                    isHit =  unit != null && unit.Owner != null && AH.Owner.TeamIdx == unit.Owner.TeamIdx;
                    break;
                default:
                    isHit = true;
            ...
            if (!IsDead && collision.transform != null && isHit)
            {
