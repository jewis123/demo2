...
namespace SuperCLine.ActionEngine
{
    ...
    public class PhysicalEntityProperty : AttackEntityProperty
    {
        ...
        [SerializeField] private HitFilterType hitType;
        ...
        [EditorProperty("命中目标类型", EditorPropertyType.EEPT_Enum, Description = "命中目标类型")]
        public HitFilterType HitType
        {
            get { return hitType; }
            set { hitType = value; }
        }
        ...
        public override void Deserialize(JsonData jd)
        {
            ...
            HitType = JsonHelper.ReadEnum<HitFilterType>(jd["HitType"]);
        }
        ...
        public override JsonWriter Serialize(JsonWriter writer)
        {
            ...
            JsonHelper.WriteProperty(ref writer, "HitType", hitType.ToString());
            return writer;
        }
