...
namespace SuperCLine.ActionEngine.Editor
{
    ...
    internal sealed partial class ActionWindow
    {
        ...
        private void SaveAction()
        {
            ...
            string path = string.Format("{0}Action/{1}.json", ResConfig.RootDataPath, UnitWrapper.Instance.ActionGroupName);
        ...
        public void DeserializeAction()
        {
            ...
            string fileName = ResConfig.RootDataResPath + ResConfig.ActionDataPath + groupName + ".json";
