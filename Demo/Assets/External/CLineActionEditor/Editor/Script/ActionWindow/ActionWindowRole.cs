...
namespace SuperCLine.ActionEngine.Editor
{
    ...
    internal sealed partial class ActionWindow
    {
        ...
        {
            SerializeProperty<PlayerProperty>(ResConfig.PathPrefix + ResConfig.PlayerPropertyFile, actorPlayerTree);
            SerializeProperty<MonsterProperty>(ResConfig.PathPrefix + ResConfig.MonsterPropertyFile, actorMonsterTree);
