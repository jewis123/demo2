...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
            ...
            else
            {
                switch (m_Tonemapping.mode.value)
                {
                    ...
                    case TonemappingMode.ACES: 
                        ...
                        Shader.SetGlobalFloat(ShaderConstants._ODT_SAT_FACTOR, m_Tonemapping.ODT_SAT_FACTOR.value);
                        Shader.SetGlobalFloat(ShaderConstants._RRT_SAT_FACTOR, m_Tonemapping.RRT_SAT_FACTOR.value);
                        break;
                    default: break; // None
                }
            }
        ...
        static class ShaderConstants
        {
            ...
            public static readonly int _RRT_SAT_FACTOR = Shader.PropertyToID("RRT_SAT_FACTOR");
            public static readonly int _ODT_SAT_FACTOR = Shader.PropertyToID("ODT_SAT_FACTOR");
