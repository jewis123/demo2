...
{
    internal class StandardShader : StandardBaseShaderGUI
    {
        private LitGUI.LitProperties litProperties;
        private LitDetailGUI.LitProperties litDetailProperties;
        private ToonParamGUI.ToonProperties toonParamProperties;
        
        private SavedBool m_DetailInputsFoldout;
        private SavedBool m_ToonParamFoldout;
        ...
        public override void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            //ToonParam
            m_ToonParamFoldout = new SavedBool($"{headerStateKey}.ToonParamFoldout", false);
        }
        ...
        public override void DrawAdditionalFoldouts(Material material)
        {
            ...
            //Toon Param
            m_ToonParamFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_ToonParamFoldout.value, ToonParamGUI.Styles.toonParamText);
            if (m_ToonParamFoldout.value)
            {
                ToonParamGUI.DoToonParamArea(toonParamProperties, materialEditor);
                EditorGUILayout.Space();
            }
            EditorGUILayout.EndFoldoutHeaderGroup();
        }
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            toonParamProperties = new ToonParamGUI.ToonProperties(properties);
        }
