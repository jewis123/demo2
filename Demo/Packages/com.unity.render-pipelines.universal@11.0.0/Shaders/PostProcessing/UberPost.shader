Shader "Hidden/Universal Render Pipeline/UberPost"
{
    HLSLINCLUDE
        ...
        half4 Frag(Varyings input) : SV_Target
        {
            ...
            #else
            {
                half4 sourceColor = SAMPLE_TEXTURE2D_X(_SourceTex, sampler_LinearClamp, uvDistorted);
                color = sourceColor.xyz;
                bloomFactor = sourceColor.w;
            }
            #endif
            ...
            #if defined(BLOOM)
            {
                ...
                bloom.xyz *= BloomIntensity * bloomFactor;
