...
namespace UnityEngine.Timeline
{
    ...
    public class ControlPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset
    {
        ...
        public override Playable CreatePlayable(PlayableGraph graph, GameObject go)
        {
            ...
            Debug.Log(sourceObject == null?"[Control Playable]Not Found sourceObject":"[Control Playable]Founded sourceObject");
        ...
        {
            Debug.Log("[Control Playable]CreateActivationPlayable");
