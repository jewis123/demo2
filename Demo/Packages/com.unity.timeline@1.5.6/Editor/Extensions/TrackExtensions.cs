...
namespace UnityEditor.Timeline
{
    ...
    public static class TrackExtensions
    {
        ...
        internal static bool GetShowTrackName(this TrackAsset track)
        {
            return TimelineWindowViewPrefs.IsShowTrackName(track);
        }

        internal static void SetShowTrackName(this TrackAsset track, bool visible)
        {
            TimelineWindowViewPrefs.SetShowTrackName(track, visible);
        }
