...
namespace UnityEditor.Timeline
{
    static class EditMode
    {
        ...
        private static bool s_showAllTrackName = false;
        ...
        public static bool showAllTrackName
        {
            get
            {
                var window = TimelineWindow.instance;
                if (window != null)
                    s_showAllTrackName = window.state.showAllTrackName;

                return s_showAllTrackName;
            }
            set
            {
                s_showAllTrackName = value;

                var window = TimelineWindow.instance;
                if (window != null)
                    window.state.showAllTrackName = value;
            }
        }
