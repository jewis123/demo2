...
namespace UnityEditor.Timeline
{
    partial class TimelineWindow
    {
        ...
        static void ShowTrackNameButton()
        {
            EditorGUI.BeginChangeCheck();
            var nameIcon =  EditMode.showAllTrackName ? DirectorStyles.nameOn : DirectorStyles.nameOff;
            var showTrackName = GUILayout.Toggle(EditMode.showAllTrackName, nameIcon, DirectorStyles.Instance.editModeBtn);
            if (EditorGUI.EndChangeCheck())
                EditMode.showAllTrackName = showTrackName;
        }
