...
namespace UnityEditor.Timeline
{
    static class TimelineWindowViewPrefs
    {
        ...
        public static bool IsShowTrackName(TrackAsset track)
        {
            if (track == null)
                return true;

            return GetTrackViewModelData(track).showName;
        }

        public static void SetShowTrackName(TrackAsset track, bool visible)
        {
            if (track == null)
                return;

            GetTrackViewModelData(track).showName = visible;
        }
