...
{
	/// <summary>
	/// 这里的代码拷贝自RenderObjectsPassFeatureEditor，在此之上屏蔽了RenderPassEvent的字段显示
	/// </summary>
	[CustomPropertyDrawer(typeof(RenderObjectsPassWrapper.Settings), true)]
    internal class FrameGraphRenderObjectSettingsEditor : PropertyDrawer
    {
